<div>
    <x-partials.alert />
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="batchCreateModal" tabindex="-1" aria-labelledby="batchCreateModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="batchCreateModalLabel">Add Batch</h5>
                ...
                <div class="modal-body">
                    ...
                    <form class="form" wire:submit.prevent="save">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="date" class="form-control" wire:model="commence_date">
                            @error('commence_date')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
