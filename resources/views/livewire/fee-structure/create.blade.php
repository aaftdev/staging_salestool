<div>
  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="feeCreateModal" tabindex="-1" aria-labelledby="feeCreateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="feeCreateModalLabel">Add Fee Stucture</h5>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <input type="number" wire:model="fees.{{ $key }}.amount" wire:keyup="calculatePercent({{ $key }})" class="form-control @error('fees.{{ $key }}.amount') is-invalid @enderror">
