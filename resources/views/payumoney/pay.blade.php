        ...
        <form action="{{$action}}" method="post" name="payuForm" class="pb-0">
            ...
            <div class="px-5 pt-4 pb-5 form-block">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3 position-relative">
                            <textarea class="input-box form-control w-100" placeholder="Note *" name="productinfo">{{ $productinfo }}</textarea>
                            <div class="icon-group-append">
